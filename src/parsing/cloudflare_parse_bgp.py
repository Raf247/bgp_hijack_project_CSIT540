...
DATA_SOURCES = {
    "route-views2": "../../data/cloudflare/route-views2",
    "route-views.sg": "../../data/cloudflare/route-views.sg",
    "route-views.eqix": "../../data/cloudflare/route-views.eqix",
}

OUTPUT_FILE = "../../results/csv/cloudflare_multi_collector_updates.csv"
