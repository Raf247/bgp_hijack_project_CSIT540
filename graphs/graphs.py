...
df = pd.read_csv("../edited code/edited_bgp_updates.csv")
...
plt.tight_layout()
plt.savefig("graph_updates_time.png")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("graph_path_length.png")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("graph_origin_distribution.png")
plt.show()